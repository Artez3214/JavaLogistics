...
public class Driver extends User implements Serializable {
    ...
    public Driver(String login, String name, String phoneNumber, String emailAddress, String birthDay, String username, String password, boolean isRetired, float salary, String currency, LocalDate healthEndDate, LocalDate driverLicenceEndDate) {
